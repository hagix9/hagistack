...
### NOVA ###
#nova install
sudo apt-get install -y nova-api nova-cert nova-consoleauth nova-scheduler nova-doc nova-conductor
sudo -E wget http://archive.ubuntu.com/ubuntu/pool/universe/libj/libjs-swfobject/libjs-swfobject_2.2+dfsg-1_all.deb
sudo dpkg -i libjs-swfobject_2.2+dfsg-1_all.deb
\rm -rf libjs-swfobject_2.2+dfsg-1_all.deb
sudo apt-get install -y novnc nova-novncproxy
